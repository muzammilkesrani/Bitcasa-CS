...
{
    public partial class CreateAccountController: BaseController
    {
        ...
        /// </summary>
        internal static CreateAccountController Instance
        {
            get
            {
                lock (syncObject)
        ...
        {
            Task<GetProfileResponse> t = CreateAccountAsync(date, username, password, authorization, email, firstName, lastName);
            Task.WaitAll(t);
            return t.Result;
        }
